...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _greensock = __webpack_require__(4);

	var _greensock2 = _interopRequireDefault(_greensock);

	var _CaptionEffect = __webpack_require__(5);

	var _CaptionEffect2 = _interopRequireDefault(_CaptionEffect);
	...
	var Animations = function () {
	    function Animations() {
	        ...
	        var captionEffect = new _CaptionEffect2.default();
	        var $ctaLoad = (0, _jquery2.default)('#load-intro-cta');
	    ...
	    _createClass(Animations, [{
	        key: 'events',
	        value: function events(cta) {
	            //cta load click event
	            cta.click(function (e) {

	                e.preventDefault();
	                var tl = new TimelineLite();
	                tl.to((0, _jquery2.default)('.loading-section'), 1.5, { opacity: 0, autoAlpha: 0, ease: Power4.easeOut }).to((0, _jquery2.default)('.loading-section'), 1, { display: 'none' });
	            });

	            //hamburger click event
	            (0, _jquery2.default)('.hamburger-menu').on('click', function () {
	                (0, _jquery2.default)('.bar').toggleClass('animate');
	                if ((0, _jquery2.default)('.bar').hasClass('animate')) {
	                    TweenLite.to((0, _jquery2.default)('.menu'), 1.5, { opacity: 1, autoAlpha: 1, ease: Power4.easeOut });
	                    (0, _jquery2.default)('.cta').addClass('cta--red-bg');
	                } else {
	                    TweenLite.to((0, _jquery2.default)('.menu'), 1.5, { opacity: 0, autoAlpha: 0, ease: Power4.easeOut });
	                    (0, _jquery2.default)('.cta').removeClass('cta--red-bg');
	                }
	            });
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	...
	var CaptionEffect = function () {
	    function CaptionEffect() {
	        _classCallCheck(this, CaptionEffect);

	        //variables
	        var $intro = (0, _jquery2.default)('.intro'),
	            $introHeadings = (0, _jquery2.default)('.intro__headings');
	    ...
	    _createClass(CaptionEffect, [{
	        key: 'generateArray',
	        value: function generateArray(intro, introHeadings) {

	            //variables:
	            var introCaption = void 0,
	                captionsList = ["Battle of The Suits IV", "We're taking White-Collar Boxing to The Next Level", "Join us on April 18th, 2018"],
	                domH1s = [];
	            ...
	            for (var i = 0; i < captionsList.length; i++) {
	                ...
	                introCaption = (0, _jquery2.default)('<h1></h1>').addClass('intro__caption').attr('id', 'caption' + (i + 1));
	        ...
	        value: function captionsTimeline(intro, introHeadings) {
	            var domH1s = this.generateArray(intro, introHeadings);
	            var captions = [];
	            for (var i = 0; i < domH1s.length; i++) {
	                captions.push(domH1s[i]);
	            }
	            var tlCaptions = new TimelineLite();

	            for (var _i = 0; _i < captions.length; _i++) {
	                tlCaptions.to(captions[_i], 2, { opacity: 1, autoAlpha: 1 });
	                //check to see if we are on the last index:
	                //i === captions.length-1 -> length = 3 -1 = 2. 
	                //i works: 0, 1 ,2 so i(2) === captions.length-1
	                if (_i + 1 === captions.length) {
	                    tlCaptions.to(captions[_i], 1, { opacity: 1, autoAlpha: 1 });
	                } else {
	                    tlCaptions.to(captions[_i], 1, { opacity: 0, autoAlpha: 0 });
	                }
	            };
	        ...
	        key: 'masterTimeline',
	        value: function masterTimeline(intro, introHeadings) {
